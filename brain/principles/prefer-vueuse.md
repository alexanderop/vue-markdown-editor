...
**When to write your own:** VueUse has no equivalent, or its behavior conflicts with a hard requirement. Document the reason in a comment so future readers don't replace it back.
